			...
			<div class="col-md-8 col-sm-12">
				...
				<div class="col-sm-12">
					...
					if ($teamparent){
						...
						echo "<div class='col-lg-12'><h3><i class='dashicons dashicons-arrow-left-alt2'></i> <a href='".get_permalink($parentteam->ID)."'>".govintranetpress_custom_title($parentteam->post_title)."</a></h3>";
						//echo wpautop($parentteam->post_content);
						echo "</div>";
					}
					?>

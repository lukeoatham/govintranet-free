<?php
/* Template name: News, alerts and blogs  */
				...
				<div class="row">
				 ...
				 <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				    <ul id="myTab" class="nav nav-tabs" role="tablist">
				      ...
				      <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">Alerts</a></li>
					        <?php
				        ...
				        <?php
							...
							$qposts = new WP_Query($cquery);
								...
								while ($qposts->have_posts()) : $qposts->the_post();
									...
									the_excerpt();
								endwhile;
								echo '<hr><p class="more-alerts"><a title="All alerts" class="small" href="'.site_url().'/alert/">All alerts</a> <span class="dashicons dashicons-arrow-right-alt2"></span></p>';	

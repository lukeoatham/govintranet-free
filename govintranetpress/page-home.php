...
<?php endif; ?>
			...
			<?php 	dynamic_sidebar('home-widget-area3'); 
				if ($forumsupport):			?>	
					<div class="category-block"><hr><p><strong><a title="More in forums" class="small" href="<?php echo site_url();?>/about-dcms/yourspace/">More in forums</a></strong> <i class='glyphicon glyphicon-chevron-right small'></i></p></div>
			<?php 	
				endif;
